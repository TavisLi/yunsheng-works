...
本站目前是允生原創小說的宣傳與閱讀網站，已提供《那些有關於他的小事》與《燦燦烈日下》作品頁、讀者帳號、跨裝置閱讀狀態與購買記錄唯讀查詢。兩部作品目前均尚未正式發佈；本站仍不是完整的出版電商平台：內容後台、支付、訂單建立、退款與完整電子書解鎖尚未建立。初期電子書金流由發行平台處理；網站後續規劃迭代為 StoryForge 公司對外官網，但該轉型尚未完成。
...
- 沒有自行處理退款或平台結算；初期由電子書發行平台依其條款負責。
- 公司官網資訊架構與品牌轉型尚未形成已批准的產品規格。
