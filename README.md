...
「允生作品」目前是允生原創小說的宣傳網站與閱讀體驗。2022 年創作的《那些有關於他的小事》是第一部小說，2026 年正在創作《燦燦烈日下》；兩部作品目前均尚未正式發佈。網站提供品牌首頁、作品展示、場景節選、作品前導與第一章免費試讀。後續規劃逐步迭代為 StoryForge 公司對外官網，但目前尚未完成該轉型。

## 目前功能

- 「允生作品」品牌首頁與作品入口
- 《那些有關於他的小事》與《燦燦烈日下》專屬作品展示頁
- 三個附插畫的公開場景節選
- 作品前導與第一章免費試讀
...
本站目前不提供內容後台、線上支付、訂單建立、退款或完整電子書解鎖。初期電子書支付、訂單、退款與平台結算由 Apple Books 或後續採用的發行平台處理；購買記錄與購買權益模型不代表本站已有自營金流。完整產品語彙與範圍請閱讀 [`CONTEXT.md`](./CONTEXT.md)。
...
| `/works/those-little-things` | 《那些有關於他的小事》作品展示頁（Work page） |
